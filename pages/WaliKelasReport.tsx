                         ...
                         return (
                            <div key={key} className="flex flex-col md:flex-row gap-4 border-b border-slate-200 pb-6 last:border-0">
                                <div className="w-full md:w-1/3 flex-shrink-0">
                                    <img src={data.image} alt="Preview" className="w-full border border-slate-200 rounded shadow-sm" />
                                </div>
                                <div className="flex-grow space-y-3">
                                    <div className="flex justify-between items-start">
                                        ...
                                        <div className="flex gap-2">
                                            <button 
                                                onClick={() => handleCopyImage(data.image)}
                                            ...
                                            <button 
                                                onClick={() => handleSendWA(item.wali?.no_hp, data.caption)}
